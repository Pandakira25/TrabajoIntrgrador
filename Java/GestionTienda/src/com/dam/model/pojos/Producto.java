...
public class Producto {
	...
	/**
	 * Devuelve una representación textual inteligible con los atributos principales del objeto Producto.
	 * * @return Cadena de texto formateada que detalla el estado actual del artículo.
	 */
	@Override
